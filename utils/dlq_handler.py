...
class DLQHandler:
    ...
    def log_error(self, topic: str, message_data: Dict[str, Any], 
    ...
    def send_to_dlq(self, original_topic: str, message_data: Dict[str, Any],
                    error: str, retry_count: int):
    ...
    def retry_message(self, topic: str, message_data: Dict[str, Any],
