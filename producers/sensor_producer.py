...
class SensorProducer:
    ...
    def generate_sensor_data(self, sensor_id: int, sensor_type: str) -> dict[str, Any]:
        ...
        base_values = {"temperature": 20.0, "humidity": 50.0, "pressure": 1013.25}

        variations = {"temperature": 30.0, "humidity": 40.0, "pressure": 50.0}
    ...
    def produce(self):
        ...
        logger.info(
            "Starting sensor producer", num_sensors=self.num_sensors, interval=self.interval
        )
